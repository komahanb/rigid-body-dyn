...
SRC  := src/dispmodule.f90 src/LUroutines.f90 src/constants.f90 src/common_utils.f90 src/utils.f90 src/solver_utils.f90 src/flex_multi_dyn.f90 src/system_components.f90 src/differ.f90 src/matrix_utils.f90 src/body.f90 src/jacobian.f90 test/pend.f90
